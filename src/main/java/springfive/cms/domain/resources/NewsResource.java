...
public class NewsResource {
  ...
  @PostMapping
  public ResponseEntity<News> createNews(NewsRequest news) {
  ...
  public ResponseEntity<Review> review(
      @PathVariable("id") String id, @PathVariable("userId") String userId) {
    return ResponseEntity.ok(new Review());
  }

  @GetMapping(value = "/revised")
  public ResponseEntity<List<News>> revised() {
    return ResponseEntity.ok(Arrays.asList(new News(), new News()));
  }
}
